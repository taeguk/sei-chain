...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/sei-protocol/sei-cosmos v0.2.62-0.20231003205750-67f3a08054b0
	github.com/cosmos/iavl => github.com/sei-protocol/iavl-v1 v1.0.0-rc.1.0.20231003205735-720b85de6030
